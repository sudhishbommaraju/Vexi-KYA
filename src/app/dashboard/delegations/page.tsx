...
import { ShieldCheck, DownloadCloud } from 'lucide-react';
  ...
  return (
    <div className="h-[70vh] flex flex-col items-center justify-center text-center max-w-[500px] mx-auto animate-in fade-in duration-500">
      <div className="w-16 h-16 rounded-[16px] bg-surface border border-border flex items-center justify-center mb-6 shadow-lg shadow-black/20">
        <ShieldCheck className="w-8 h-8 text-textMuted" />
      </div>
      
      <h2 className="text-2xl font-bold text-textPrimary tracking-tight mb-3">Policy Delegations</h2>
      <p className="text-[15px] text-textSecondary leading-relaxed mb-8">
        Delegations and scopes require localized signing of cryptographic capabilities. This ensures policies cannot be maliciously modified by a central server.
      </p>
